...
struct Erase<TypeList<Head, Tail...>, T> {
	using Result = typename Append<typename Erase<TypeList<Tail...>, T>::Result, Head>::Result;
};
...
int main() {
	...
	std::cout << "Erase(FourElementList, int) = " << typeid(Erase<FourElementList, double>::Result).name() << std::endl;
	std::cout << "Erase(FourElementList, unsigned char) = " << typeid(Erase<FourElementList, std::string>::Result).name() << std::endl;
